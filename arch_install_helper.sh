...
pacman -S plasma-desktop sddm sddm-kcm kwayland-integration plasma-wayland-session konsole dolphin dolphin-plugins kdeconnect kcron ksystemlog plasma-disks plasma-systemmonitor kwalletmanager kwallet-pam gnome-keyring seahorse gparted gnome-disk-utility ark lrzip lzop p7zip unrar unarchiver filelight kcalc gwenview okular kdenlive kdenetwork-filesharing print-manager bluedevil breeze-gtk appmenu-gtk-module drkonqi kde-gtk-config kdeplasma-addons kgamma5 khotkeys kinfocenter kscreen ksshaskpass kwrited plasma-browser-integration plasma-firewall plasma-nm plasma-pa plasma-thunderbolt plasma-workspace-wallpapers powerdevil xdg-desktop-portal-kde
